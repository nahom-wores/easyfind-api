...
public class SubscriptionService(ApplicationDbContext db,
    IChapaClient chapa, UserManager<ApplicationUser> userManager, IConfiguration config,
    ILogger<SubscriptionService> logger) : ISubscriptionService
{
    
    public async Task<Result<CheckoutResponseDto>> InitiateAsync(string userId,
